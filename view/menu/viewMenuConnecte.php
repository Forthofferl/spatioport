<li class="active" ><a href="utilisateur.php?action=accueil"><span class="fa fa-gamepad"></span> Accueil</a></li>
<li class="active" ><a href="vaisseau.php?action=search"><span class="fa fa-sort-amount-asc"></span> Recherche de vaisseau</a></li>
