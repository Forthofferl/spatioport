...
<html lang="fr">
    ...
    <body>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li <?php if (isset($vue)) if (($page=="index" && $vue=="Vaisseaux")) echo 'class="active"'; ?>><a href="index.php?action=Vaisseau">Vaisseau</a></li>
                    <li <?php if (isset($vue)) if ($page=="index" && $vue=="Recherche") echo 'class="active"'; ?>><a href="index.php?action=rechercher">Rechercher</a></li>
        ...
        <div id="footer">
            <div class="container">
                <p class="credit">Copyright © 2014 -</p>
            </div>
        </div>
